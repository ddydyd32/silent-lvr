...
def union_tensor_dict(tensor_dict1: TensorDict, tensor_dict2: TensorDict) -> TensorDict:
    ...
    for key in tensor_dict2.keys():
        ...
        if key in tensor_dict1:
            ...
            try:
                with tensor_dict1.unlock_():
                    tensor_dict1.set(key, tensor_dict2[key])
            except Exception as e:
                print('tensordict1 keys:', tensor_dict1.keys())
                print('tensordict2 keys:', tensor_dict2.keys())
                raise e
    return tensor_dict1
...
class DataProto:
    ...
    def __getitem__(self, item: Union[int, slice, list, np.ndarray]) -> Union["DataProto", "DataProtoItem"]:
        ...
        is_batch = (
            ...
            (hasattr(item, 'dtype') and hasattr(item, '__len__'))  # torch.Tensor 等
        )
    ...
    def chunk(self, chunks: int) -> List["DataProto"]:
        ...
        """
        # print('len(self)=', len(self), 'chunks=', chunks)
