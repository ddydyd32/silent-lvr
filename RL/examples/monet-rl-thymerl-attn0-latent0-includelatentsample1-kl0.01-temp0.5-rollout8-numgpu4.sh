#!/bin/bash -l
#SBATCH --job-name=monet-rl-thymerl-necessity0-attn0-latent0-includelatentsample1-kl0.01-temp0.5-rollout8-numgpu4
#SBATCH --output=monet-rl-thymerl-necessity0-attn0-latent0-includelatentsample1-kl0.01-temp0.5-rollout8-numgpu4.-%j.log
